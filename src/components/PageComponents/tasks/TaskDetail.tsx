...
export default function TaskDetail({
  ...
  return (
    ...
    >
      <motion.div
        className="taskDetail md:pt-21 fixed right-0 top-0 z-20 h-full w-[48.69rem] overflow-y-auto border-l border-border-primary bg-background-secondary pb-16 pt-24 md:w-[27.19rem] md:px-6 sm:w-full sm:px-4 sm:pt-20 [&&]:lg:px-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
